...
public interface NewsService {
     ...
     * @return 所有新闻
     */
    List<Nd_News> showNews(String title);
     ...
     * @return 我的新闻
     */
    List<Nd_News> showMyNews( String owner);
     ...
     * @return 1成功0失败
     */
    boolean updateNews(Nd_News news);
